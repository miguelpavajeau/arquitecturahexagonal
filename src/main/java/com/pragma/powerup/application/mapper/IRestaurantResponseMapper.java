...
public interface IRestaurantResponseMapper {
    ...
    RestaurantListResponseDto toListResponse(RestaurantModel restaurantModel);

    List<RestaurantListResponseDto> toListResponseList(List<RestaurantModel> restaurantModelList);
}
