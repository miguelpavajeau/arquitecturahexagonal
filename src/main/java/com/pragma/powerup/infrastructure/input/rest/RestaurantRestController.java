...
public class RestaurantRestController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "Invalid data or owner", content = @Content)
    })
    ...
    @Operation(summary = "List restaurants (paginated, alphabetical) for clients")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Paginated restaurants returned", content = @Content),
